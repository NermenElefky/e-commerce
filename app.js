...
add_btn.addEventListener("click",()=>{
    add_btn.querySelector(".after").style.animation= "mm 1s 1";
    add_btn.querySelector(".before").style.animation = "mm 1s 1";
    setTimeout(() => {
        add_btn.querySelector(".before").style.animation = "";
        add_btn.querySelector(".after").style.animation= "";
    }, 800);
})
